...
export function startAnalytics() {
  ...
  try {
    posthog.init(KEY, {
      ...
      // Everything that watches the page rather than the named events below,
      // switched off by name: newer defaults turn several of these on, and
      // dead-click and rage-click capture record the text of what was tapped.
      autocapture: false,
